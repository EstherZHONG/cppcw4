...
DEPS = BaseEngine.cpp FontManager.cpp TileManager.cpp DisplayableObject.cpp JPGImage.cpp MainGame.cpp Psyjz9TileManager.cpp MovingObject.cpp UserObject.cpp EnemyObject.cpp Psyjz9Engine.cpp 
